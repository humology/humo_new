defmodule Humo.Integration.CodeGeneration.AppWithMSSQLAdapterTest do
  ...
  describe "phx.gen.html" do
    ...
    test "has a passing test suite" do
      with_installer_tmp("app_with_defaults", fn tmp_dir ->
        {app_root_path, _} =
          generate_humo_app(tmp_dir, "default_mssql_app", ["--database", "mssql"])
  ...
  describe "phx.gen.live" do
    ...
    test "has a passing test suite" do
      with_installer_tmp("app_with_defaults", fn tmp_dir ->
        {app_root_path, _} =
          generate_humo_app(tmp_dir, "default_mssql_app", ["--database", "mssql", "--live"])
