defmodule HumoNew.Single do
  ...
  template(:new, [
    ...
    {:eex, "humo_web/views/error_helpers.ex", :project,
     "lib/:lib_web_name/views/error_helpers.ex"},
  ...
  template(:html, [
    ...
    {:eex, "humo_test/controllers/page_controller_test.exs", :project,
     "test/:lib_web_name/controllers/page_controller_test.exs"},
    {:eex, "humo_test/views/page_view_test.exs", :project,
     "test/:lib_web_name/views/page_view_test.exs"},
    {:eex, "humo_web/controllers/dashboard/page_controller.ex", :project,
     "lib/:lib_web_name/controllers/dashboard/page_controller.ex"},
    {:eex, "humo_web/views/dashboard/page_view.ex", :project,
     "lib/:lib_web_name/views/dashboard/page_view.ex"},
    {:eex, "humo_test/views/dashboard/page_view_test.exs", :project,
     "test/:lib_web_name/views/dashboard/page_view_test.exs"},
    {:eex, "humo_web/templates/layout/root.html.heex", :project,
     "lib/:lib_web_name/templates/layout/root.html.heex"},
    {:eex, "humo_web/templates/layout/app.html.heex", :project,
     "lib/:lib_web_name/templates/layout/app.html.heex"},
    {:eex, "humo_web/templates/layout/dashboard.html.heex", :project,
     "lib/:lib_web_name/templates/layout/dashboard.html.heex"},
    {:eex, "humo_web/templates/layout/minimal-modal.html.heex", :project,
     "lib/:lib_web_name/templates/layout/minimal-modal.html.heex"},
    {:eex, "humo_web/templates/layout/live.html.heex", :project,
    ...
    {:eex, "humo_web/templates/page/index.html.heex", :project,
     "lib/:lib_web_name/templates/page/index.html.heex"},
    {:eex, "humo_web/templates/dashboard/page/index.html.heex", :project,
     "lib/:lib_web_name/templates/dashboard/page/index.html.heex"},
    {:eex, "humo_test/views/layout_view_test.exs", :project,
     "test/:lib_web_name/views/layout_view_test.exs"},
    {:text, "humo_assets/vendor/topbar.js", :web, "assets/vendor/topbar.js"}
  ])
  ...
  template(:assets, [
    {:text, "humo_assets/css/all_plugins.scss", :web, "assets/css/all_plugins.scss"},
    {:text, "humo_assets/css/app.scss", :web, "assets/css/app.scss"},
    {:text, "humo_assets/css/plugin.scss", :web, "assets/css/plugin.scss"},
    {:text, "humo_assets/js/all_plugins.js", :web, "assets/js/all_plugins.js"},
    {:text, "humo_assets/js/app.js", :web, "assets/js/app.js"},
    {:text, "humo_assets/js/plugin.js", :web, "assets/js/plugin.js"},
    {:text, "humo_assets/build.config.mjs", :web, "assets/build.config.mjs"},
    {:text, "humo_assets/build.mjs", :web, "assets/build.mjs"},
    {:eex, "humo_assets/package.json", :web, "package.json"}
  ])

  template(:static, [
    {:keep, "humo_assets/static/images", :web, "assets/static/images"},
    {:text, "humo_assets/static/images/tabler-sponsor-banner-homepage.svg", :web,
     "assets/static/images/tabler-sponsor-banner-homepage.svg"}
  ])
